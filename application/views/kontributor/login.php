						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2"><?php echo $judul;  ?></span>
								</h1>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
                                                                        ...
                                                                        <h4>Peringatan!</h4>
                                                                         ...
                                                                         <div class="alert alert-danger" role="alert">
                                                                          ...
                                                                          <h4>kesalahan!</h4>
                                                                            ...
                                                                            <?php };?>
											<div class="space-6"></div>
                                                                                        <?php echo form_open('kontributor/auth/proseslogin') ?>
											<form>
												<fieldset>
										...
										<div class="toolbar clearfix">
											...
											<div>
												<a href="<?php echo base_url(); ?>kontributor/register"  class="user-signup-link">
													I want to register
										...
										<div class="widget-main">
											...
											<div class="space-6"></div>
                                                                        ...
                                                                        <div class="alert alert-warning" role="alert">
                                                                            <button type="button" class="close" data-dismis="alert">x</button>
                                                                        <h4>Peringatan!</h4>
                                                                             <?php echo $this->session->flashdata('err1');?>
                                                                          </div>
                                                                         <?php } else if($this->session->flashdata('msg1')) { ?>
                                                                         <div class="alert alert-danger" role="alert">
                                                                             <button type="button" class="close" data-dismis="alert">x</button>
                                                                          <h4>kesalahan!</h4>
                                                                               <?php echo $this->session->flashdata('ms1');?>
                                                                            </div>
                                                                            <?php };?>
											<p> Enter your details to begin: </p>
                                                                                        <?php echo form_open('kontributor/register') ?>
											<form>
												<fieldset>
                                                                                                        <label class="block clearfix">
														<span class="block input-icon input-icon-right">
