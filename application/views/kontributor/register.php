...
<head>
    ...
    <title>Register Kontributor</title>
...
<body class="login-layout">
		<div class="main-container">
            ...
            <div class="panel-body">
                <?php
                echo form_open("kontributor/register");?>
                ...
                <?php echo $this->session->flashdata('msg'); ?>
											...
											<a href="<?php echo base_url(); ?>kontributor/auth" data-target="#login-box" class="back-to-login-link">
