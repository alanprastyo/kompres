<div class="panel-body">
	...
	echo form_open_multipart('kontributor/dashboard/update_profile');  
...
<div class="page-header">
	...
	<label class="col-sm-2" for="form-field-1"> Nama </label>
            <div class="col-sm-10">
                <input type="hidden" name="id" value="<?php echo $p->id_kontributor?>">
	...
	<label class="col-sm-2" > No Handphone </label>
            <div class="col-sm-10">
                <input type="tel"  name="no_hp" value="<?php echo $this->session->userdata('no_hp') ?>" placeholder="nomor handphone" class="col-xs-8 col-sm-5" />
            </div>
	</div>
